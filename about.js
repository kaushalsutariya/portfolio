...
nav_toggle.addEventListener('click',()=>{
    if(x.matches && y.matches){
        ...
        if(toggle_value == false){
            ...
            document.getElementById('main_body').style.top = '-470vw';
            document.getElementById('main_body').style.width = 'calc(100% - 25vw)';
            document.getElementById('main_body').style.height = '560vw';
            ...
            document.getElementById('nav_toggler').style.height = '560vw';
