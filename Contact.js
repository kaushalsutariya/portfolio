...
nav_toggle.addEventListener('click',()=>{
    if(x.matches && y.matches){
        ...
        if(toggle_value == false){
            ...
            document.getElementById('main_body').style.top = '-150vw';
            document.getElementById('main_body').style.width = 'calc(100% - 25vw)';
            document.getElementById('main_body').style.height = '210vw';
            ...
            document.getElementById('nav_toggler').style.height = '190vw';
            ...
            document.getElementById('main_body').style.height = '190vw';
            document.getElementById('main_body').style.top = '-130vw';
